...
//const StyledButtonGroup: any = SCButtonGroup.withComponent<any>(ButtonGroup)
//@inject('navigation')


@observer
class _IconNavBar extends React.Component<any, any> {
    public render() {
        return (     
              <StyledButtonGroup fill={true} vertical={true}>
                ...
                <BlueprintNavIcon icon={IconNames.GRAPH} size={35} large={true}  route="/pages/workflowgraph" />
...
export let IconNavBar = withRouter(_IconNavBar)
