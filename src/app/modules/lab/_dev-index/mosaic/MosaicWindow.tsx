...
import { MosaicWindowBody, MosaicWindowPreview, MosaicWindowPreviewToolbar, MosaicWindowBodyOverlay, additionalalToolbarCSS, MosaicWindowTitle } from './Mosaic';
...
> {
  static defaultProps: Partial<InternalMosaicWindowProps<any>> = {
    ...
    renderPreview: ({ title }) => (
      <div>
      <MosaicWindowPreview>
        <MosaicWindowPreviewToolbar>
          <MosaicWindowTitle>{title}</MosaicWindowTitle>
        </MosaicWindowPreviewToolbar>
        <MosaicWindowBody>
          <h4>{title}</h4>
  ...
  render() {
    ...
    return connectDropTarget(
      ...
      >
        {this.renderToolbar()}
        <MosaicWindowBody>{this.props.children!}</MosaicWindowBody>
        <MosaicWindowBodyOverlay onClick={() => this.setAdditionalControlsOpen(false)} />
        <div style={additionalalToolbarCSS}>{additionalControls}</div>
