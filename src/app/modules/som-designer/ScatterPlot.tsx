...
export class ScatterPlot extends React.Component<ScatterPlotProps, any> {
  ...
  protected datasetPoints: THREE.Points;

  protected sampleIndicatorGeometry: THREE.Geometry;
  protected sampleIndicatorPoints: THREE.Points;
