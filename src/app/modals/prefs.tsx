...
export interface PreferenceProps {
  ...
  indentWithSpace: Function | any
  indentWithTab: Function | any
  isTabIndent: boolean
  ...
  gridOutput: boolean
  soundOutput: boolean
  setTextOutput: Function
  setGridOutput: Function
  setSoundOutput: Function
  lintWarning: boolean
  setLintWarning: Function
  theme: string
  serveSecure: boolean
  setServeSecure: Function
  setTheme: Function
};


class Preferences extends React.Component<PreferenceProps, {}> {
  fontSizeInput: HTMLInputElement;
  indentationInput: HTMLInputElement;
