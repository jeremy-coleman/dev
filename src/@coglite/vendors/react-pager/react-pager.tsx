...
class Pager extends React.Component<any, any> {
  static propTypes: { 
    ...
    visiblePages: PropTypes.Validator<number>;
    titles: PropTypes.Requireable<object>;
    onPageChanged: PropTypes.Requireable<any>; 
  };
...
export {Pager as default, Pager, PagerProps, Page};