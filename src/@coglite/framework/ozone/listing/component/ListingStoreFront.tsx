    ...
    render() {
        return (
            <ListingStoreFrontSection
                ...
                <Sync sync={this.props.storeFront.sync} onRenderDone={this._onRenderDone} syncLabel={`Loading ${this.props.title} Listings...`} />
            </ListingStoreFrontSection>
        );
    }
}
...
class ListingStoreFrontContainer extends React.Component<IListingStoreFrontProps, any> {
    ...
    render() {
        return <Sync sync={this.props.storeFront.sync} onRenderDone={this._onRenderDone} />
    }
}
