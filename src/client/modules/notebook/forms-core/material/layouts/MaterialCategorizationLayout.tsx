...
import { and, Categorization, mapStoreValuesToLayoutProps, RankedTester, rankWith, RendererProps, Tester, UISchemaElement, uiTypeIs } from '../../core';
import { createPropsForItem, RendererComponent } from '../../react';
...
@observer
export default class MaterialCategorizationLayout extends React.Component<any, any>  {
  render() {
