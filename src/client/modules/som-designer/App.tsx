...
import {DatasetSource, SOMController } from "../../lib";
...
import { style as Typestyle } from 'typestyle/lib';
...
export class SOMDesigner extends React.Component<any, ISOMDesignerState> {
    ...
    <SplitterLayout percentage secondaryInitialSize={25} style={{height: '100%', position: 'relative', display: 'flex', flexDirection: 'row'}}>
      ...
      <div className={"som-grid-plot"}>
        ...
        />
          ...
          <FillParent>
            <div className={Typestyle(flex, vertical)}>
      <div className={"som-sidebar"}>
