...
import {Model, Trainer, Initializer, RandomInitializer, PCAInitializer} from "../../../lib";


//import '../som.styles'
//const style = require("./ModelTab.scss");

//import {style} from './ModelTab.style'
...
export class ModelTab extends React.Component<IProps, any> {
  ...
  protected renderModelControls() {
    return <div>
      <div className={"som-control-with-label"}>
        <span>Size</span>
        <NumberInput
          min={1}
          step={1}
  ...
  render() {
    return <div className={"som-tab"} ref={"tab"}>
      <h2>Model</h2>
