...
import {GoPlus, GoAlert} from 'react-icons/go'
...
*/
    ...
    private stepTitle(parentList: WorkflowStep[], step: WorkflowStep, key: number) {
        ...
        return (
            <span>
                {step.transient.parseError.length > 0 && !step.transient.errorsDismissed && <GoAlert className={classes.stepError}/>}
    ...
    private StepHandle () {
        return <div className={this.props.classes.handle}>
            ...
            {this.props.state.ide ? <span className={this.props.classes.handleIcon}></span> : <FaBars className={this.props.classes.handleIcon}/>}
        </div>
    }
        ...
        return (
            <div>
                ...
                <div 
                    ...
                    {this.state.dragging ? 
                        <span><FaTrash />{translate('DELETE')}...</span> :
                        <span><GoPlus /> {translate('ADD_STEP')}...</span> }
                    <div></div>
                </div>
            </div>)
    }
