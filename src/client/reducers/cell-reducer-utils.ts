...
export { moveCell, scrollToCellIfNeeded, addExternalDependency, getSelectedCell, getSelectedCellId, getCellBelowSelectedId, newStateWithSelectedCellPropertySet, newStateWithSelectedCellPropsAssigned, newStateWithRowOverflowSet, newStateWithPropsAssignedForCell, };
