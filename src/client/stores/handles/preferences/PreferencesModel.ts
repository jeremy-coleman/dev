...
import {IStorageService } from "@coglite/framework/common/service";
//import {StorageServiceContext } from "@coglite/framework/common/lib";


class PreferencesModel implements IPreferencesModel {

    private _rootKey: string;
    @observable protected _sync = new Sync();
    ...
    protected get storageKey() {
        return `coglite-prefs-${this._rootKey}`
    }
