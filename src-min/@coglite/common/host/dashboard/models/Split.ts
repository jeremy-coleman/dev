...
export class SplitModel extends ComponentModel {
    @observable protected _offset : number;
    @observable protected _first ; //component
    @observable protected _second ; //component
...
export class HSplitModel extends SplitModel {
    ...
    get columnCount() {
        ...
        const leftCount = left && left.type === ComponentTypes.hsplit ? (left as any).columnCount : 1;
        const rightCount = right && right.type === ComponentTypes.hsplit ? (right as any).columnCount : 1;
...
export class VSplitModel extends SplitModel {
    ...
    get rowCount() {
        ...
        const topCount = top && top.type === ComponentTypes.vsplit ? (top as any).rowCount : 1;
        const bottomCount = bottom && bottom.type === ComponentTypes.vsplit ? (bottom as any).rowCount : 1;
