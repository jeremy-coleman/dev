...
import {ToggleDisplay} from '@coglite/vendors/react-toggle-display';


//import {cssRaw} from 'typestyle'
//cssRaw(require('./react-select.css'));
//cssRaw(require('./styles/index.css'));
...
class VirtualizedPivotApp extends React.Component<any, any> {
...
export {VirtualizedPivotApp as default, VirtualizedPivotApp}