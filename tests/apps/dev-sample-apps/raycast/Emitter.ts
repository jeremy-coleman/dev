...
export default class Emitter extends EmitterBase {
    static ON_MOUSE_OVER: string;
    static ON_MOUSE_OUT: string;
    static ON_MOUSE_ENTER: string;
    static ON_TOUCH_START_INSIDE: string;
    static ON_MOUSE_LEAVE: string;
    static ON_MOUSE_UP: string;
    static ON_MOUSE_MOVE: string;
    static ON_CLICK: string;
    static ON_DOUBLE_CLICK: string;
    static ON_CONTEXT_MENU: string;
    static ON_TOUCH_END: string;
    static ON_TOUCH_MOVE: string;
    static ON_TOUCH_CANCEL: string;
    static ON_CHANGE: string;
    static ON_INPUT: string;
    static ON_SUBMIT: string;
    static ON_FOCUS: string;
    static ON_BLUR: string;
    static ON_KEY_DOWN: string;
    static ON_KEY_UP: string;
    static ON_PRESS: string;
    static ON_WHEEL: string;
    static ON_RESIZE: string;
    static ON_SCROLL: string;
