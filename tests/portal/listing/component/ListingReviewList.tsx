...
class ListingReviewListContainer extends React.Component<IListingReviewListProps, any> {
    ...
    render() {
        return <SyncSpinner sync={this.props.reviewList.sync} onRenderDone={this._onRenderDone} syncLabel="Loading Reviews..." />
    }
}
export { IListingReviewListProps, ListingReviewListContainer, ListingReviewList, ListingReviewSummary };
