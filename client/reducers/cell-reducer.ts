...
import { getCellBelowSelectedId, getSelectedCellId, moveCell, newStateWithPropsAssignedForCell, newStateWithRowOverflowSet, newStateWithSelectedCellPropertySet, newStateWithSelectedCellPropsAssigned, scrollToCellIfNeeded } from './cell-reducer-utils';
...
//export {cellReducer}
export {cellReducer as default, cellReducer}
