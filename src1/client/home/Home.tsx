...
export let Outline: any = styled('div')({
    position: "relative",
    width: 100,
    height: 100,
    margin: 10,
...
export let TopHalf: any = styled('div')((theme: any) => ({
    display: "flex",
     alignItems: "center",
...
export let Title: any = styled('div')({
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    padding: 8 
...
export let BottomHalf: any = styled('div')(({theme}: any) => ({
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    position: "absolute",
