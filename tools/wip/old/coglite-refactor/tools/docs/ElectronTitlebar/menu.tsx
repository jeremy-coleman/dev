...
export class MenuListItem extends React.PureComponent<any> {
...
class MenuList extends React.PureComponent<any> {
  getRowHeight = ({ index }) => {
...
export class MenuBar extends React.PureComponent<any, any> {
  lock: any
  menuItems: any
