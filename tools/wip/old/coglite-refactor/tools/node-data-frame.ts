...
export function DataFrame (opts) {
  this.rows = opts.rows
...
export let calculate = function(opts) {
...
export let getResults = function() {
  var self = this
...
export let parseResults = function(results, level) {
  var self = this
  var level = level || 0
  var rows = []
...
export let createSetKeys = function(dimensions, row) {
  var keys = []
...
export let createSetKey = function (dimensions, row) {
  var self = this
...
export let findDimension = function (title) {
  return _.find(this.dimensions, function(d) {
    return d.title === title
  })
}

export let getSortValue = function(result) {
...
export function parseSetKey (setKey) {
  var parsed = {}
