...
var TypeCheckerPlugin = require('fuse-box-typechecker').TypeHelper
...
import { asyncRoutes, IAsyncRoutes } from './src/coglite/router/routes-async';
...
Sparky.task('build', () => {
    ...
    // Vendor bundle
    fuse.bundle(`public/${directory.js}/vendor`).instructions('~app-components/app-container.tsx');

    // Server Bundle
    serverBundle = fuse.bundle('electron-ssr').splitConfig({
