...
deleteOutputFolder().then(() => {
  ...
  return createWindowsInstaller({
    appDirectory: path.resolve(outPath, 'coglite-win32-ia32'),
    iconUrl: 'https://raw.githubusercontent.com/coglite/coglite-desktop/master/assets/icons/win/logo.ico',
    noMsi: true,
    outputDirectory: path.resolve(outPath, 'windows-installer'),
    setupExe: 'cogliteSetup.exe',
