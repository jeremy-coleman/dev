...
export let Outline = (...props) => <div className={style({
    position: "relative",
    width: 100,
    height: 100,
    margin: 10,
...
export let TopHalf = (...props) => <div className={style({
    display: "flex",
     alignItems: "center",
...
export let Title = (...props) => <div className={style({
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    padding: 8 
...
export let BottomHalf = (...props) => <div className={style({
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    position: "absolute",
